...
import { ProjectCategoriesModal } from "./components/project-categories-modal_admin";
import ProjectOverview from "./components/project-overview_admin";
...
export default function ProjectsPage() {
  ...
  const loadProjects = useCallback(async (showLoadingIndicator = true) => {
    try {
      ...
      const response = await fetch(`/api/projects_admin?${params}`, {
        headers: {
