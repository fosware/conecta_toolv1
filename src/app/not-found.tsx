  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <head>
        ...
        <meta name="description" content="ConectaTool - Página no encontrada" />
        <link rel="icon" href="/favicon.ico" />
      </head>
      <body className="h-screen flex flex-col items-center justify-center bg-background text-foreground">
        <ThemeProvider
          attribute="class"
          defaultTheme="dark"
          enableSystem={false}
